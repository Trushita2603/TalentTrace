...
const Sort=(props)=>{
  ...
  const options = props.sort==="job"?opt
    .map((item) => (
  ...
  return (
      ...
      >
        <Combobox.Target withAriaAttributes={false}>
          <div onClick={()=>combobox.toggleDropdown()} className='border border-bright-sun-400 flex items-center text-sm xs-mx:text-xs xs-mx:gap-1 xs-mx:px-1 gap-2 px-2 py-1 xsm-mx:mt-2 rounded-lg cursor-pointer'>
