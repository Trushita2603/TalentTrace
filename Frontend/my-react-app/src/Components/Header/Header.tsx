...
const Header = ()=>{
    ...
    return location.pathname!=="/sign-up"&&location.pathname!=="/login"?<div className="flex justify-between w-full px-6 bg-mine-shaft-950 text-white h-24 items-center font-['poppins']">
